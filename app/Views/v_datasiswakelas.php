                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?php echo site_url('tambahsiswa'); ?>" class="btn btn-success"><i
                                        class="fas fa-user-plus"></i> Data Siswa</a>
                                <div class="card-tools">
                                    <form action="<?= site_url('datasiswakelas/search'); ?>" method="post">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach ($kelasWali as $item): ?>
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <td><?php echo $item['kelas']; ?></td>
                                                <td><?php echo $item['wali_kelas']; ?></td>
                                                <td><a href="<?php echo site_url('datasiswag/tampilkanDataSiswa/' . $item['kelas']); ?>"
