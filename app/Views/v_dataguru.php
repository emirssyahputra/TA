...
<script>
    $(document).ready(function () {
        // Tangkap pesan sukses atau pesan error dari flash data
        <?php if (session()->getFlashdata('success')): ?>
            // Tampilkan toast notification untuk pesan sukses
            showNotification('<?php echo session()->getFlashdata('success'); ?>', 'success');
        <?php elseif (session()->getFlashdata('error')): ?>
            // Tampilkan toast notification untuk pesan error
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <?php foreach ($guru as $index => $admin):
                                            $nama = $admin['nama'];
