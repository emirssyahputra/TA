        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('cetak');?>" class="nav-link active" style="font-size: 90%;">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Cetak Riwayat Pelanggaran</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Cetak Riwayat Pelanggaran</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <form class="forms-sample" method="post" action="<?= site_url('cetak/printPdf') ?>">
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" id="exampleInputUsername1" name="bulan"
                                placeholder="bulan" value="" required>
                        </div>
                        <div class="form-group">
